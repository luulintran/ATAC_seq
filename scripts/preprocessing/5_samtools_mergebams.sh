...
nicd_replicates=("filtered_bams/NICD_REP1.mLb.clN.sorted_filtered.bam" "filtered_bams/NICD_REP1.mLb.clN.sorted_filtered.bam" "filtered_bams/NICD_REP3.mLb.clN.sorted_filtered.bam")
