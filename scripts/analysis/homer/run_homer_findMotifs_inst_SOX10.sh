...
# Define motif name
MOTIF_NAME="SOX10" # Change this as needed. This adds the motif name to the output file name.
...
MOTIF="NICD_motifs/homerResults/motif8.motif" # Motif file corresponding to $MOTIF_NAME. Change as needed. SOX10 motif file was in NICD homerResults
